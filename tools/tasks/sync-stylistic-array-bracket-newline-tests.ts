...
const RULE = 'array-bracket-newline';
...
const CAPTURE_KEY = '__stylisticArrayBracketNewlineCapture__';
...
const fixture = {
  __generated: {
    ...
    license: 'MIT',
    tool: 'tools/tasks/sync-stylistic-array-bracket-newline-tests.ts',
  },
  valid,
  invalid,
};
...
function registerCaptureHooks(): void {
  ...
  registerHooks({
    resolve(specifier, context, nextResolve) {
      ...
      if (
        specifier === './array-bracket-newline' ||
        specifier === './types' ||
