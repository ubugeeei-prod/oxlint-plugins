...
impl<'a> Scanner<'a> {
    pub(crate) fn check_prefer_array_some_binary(
        &mut self,
    ...
    pub(crate) fn check_prefer_array_some_unary(
        &mut self,
    ...
    pub(crate) fn check_prefer_array_some_call(
        &mut self,
    ...
    pub(crate) fn report_array_some(
        &mut self,
        span: Span,
        call: &'a CallExpression<'a>,
        negate: bool,
