//! Adapter for the `react-hooks` plugin (port of eslint-plugin-react-hooks).
...
pub const PLUGIN: &str = "react-hooks";

pub fn info() -> PluginInfo {
    PluginInfo {
        plugin: PLUGIN,
        rules: core::implemented_react_hooks_rule_names()
            .iter()
...
pub fn scan(
    ...
    for diagnostic in core::scan_react_hooks(source_text, filename) {
