...
**26** ESLint plugins are being ported · **718 / 1159** rules implemented (**62%**).
...
| [`sonarjs`](npm/sonarjs)                                   | [`eslint-plugin-sonarjs`](https://github.com/SonarSource/SonarJS)                                                      | 180         | 269   | 67%      |
