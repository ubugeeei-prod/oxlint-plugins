...
**26** ESLint plugins are being ported · **763 / 1159** rules implemented (**66%**).
...
| [`sonarjs`](npm/sonarjs)                                   | [`eslint-plugin-sonarjs`](https://github.com/SonarSource/SonarJS)                                                      | 225         | 269   | 84%      |
