...
**26** ESLint plugins are being ported · **740 / 1159** rules implemented (**64%**).
...
| [`sonarjs`](npm/sonarjs)                                   | [`eslint-plugin-sonarjs`](https://github.com/SonarSource/SonarJS)                                                      | 202         | 269   | 75%      |
