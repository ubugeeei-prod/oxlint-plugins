...
**26** ESLint plugins are being ported · **739 / 1159** rules implemented (**64%**).
...
| [`sonarjs`](npm/sonarjs)                                   | [`eslint-plugin-sonarjs`](https://github.com/SonarSource/SonarJS)                                                      | 201         | 269   | 75%      |
