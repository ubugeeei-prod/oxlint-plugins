...
**26** ESLint plugins are being ported · **756 / 1159** rules implemented (**65%**).
...
| [`sonarjs`](npm/sonarjs)                                   | [`eslint-plugin-sonarjs`](https://github.com/SonarSource/SonarJS)                                                      | 218         | 269   | 81%      |
