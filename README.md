...
**26** ESLint plugins are being ported · **630 / 1159** rules implemented (**54%**).
...
| [`sonarjs`](npm/sonarjs)                                   | [`eslint-plugin-sonarjs`](https://github.com/SonarSource/SonarJS)                                                      | 96          | 269   | 36%      |
