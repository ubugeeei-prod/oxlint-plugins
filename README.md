...
**26** ESLint plugins are being ported · **766 / 1159** rules implemented (**66%**).
...
| [`sonarjs`](npm/sonarjs)                                   | [`eslint-plugin-sonarjs`](https://github.com/SonarSource/SonarJS)                                                      | 228         | 269   | 85%      |
