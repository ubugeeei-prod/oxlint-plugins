...
**26** ESLint plugins are being ported · **771 / 1159** rules implemented (**67%**).
...
| [`sonarjs`](npm/sonarjs)                                   | [`eslint-plugin-sonarjs`](https://github.com/SonarSource/SonarJS)                                                      | 233         | 269   | 87%      |
