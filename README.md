...
**26** ESLint plugins are being ported · **706 / 1159** rules implemented (**61%**).
...
| [`sonarjs`](npm/sonarjs)                                   | [`eslint-plugin-sonarjs`](https://github.com/SonarSource/SonarJS)                                                      | 168         | 269   | 62%      |
