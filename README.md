...
**26** ESLint plugins are being ported · **678 / 1159** rules implemented (**58%**).
...
| [`sonarjs`](npm/sonarjs)                                   | [`eslint-plugin-sonarjs`](https://github.com/SonarSource/SonarJS)                                                      | 140         | 269   | 52%      |
