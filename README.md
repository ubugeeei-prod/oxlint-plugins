...
**26** ESLint plugins are being ported · **609 / 1159** rules implemented (**53%**).
...
| [`sonarjs`](npm/sonarjs)                                   | [`eslint-plugin-sonarjs`](https://github.com/SonarSource/SonarJS)                                                      | 83          | 269   | 31%      |
