...
**26** ESLint plugins are being ported · **701 / 1159** rules implemented (**60%**).
...
| [`sonarjs`](npm/sonarjs)                                   | [`eslint-plugin-sonarjs`](https://github.com/SonarSource/SonarJS)                                                      | 163         | 269   | 61%      |
