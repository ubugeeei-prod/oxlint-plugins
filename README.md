...
**26** ESLint plugins are being ported · **658 / 1159** rules implemented (**57%**).
...
| [`sonarjs`](npm/sonarjs)                                   | [`eslint-plugin-sonarjs`](https://github.com/SonarSource/SonarJS)                                                      | 123         | 269   | 46%      |
