...
**26** ESLint plugins are being ported · **675 / 1159** rules implemented (**58%**).
...
| [`sonarjs`](npm/sonarjs)                                   | [`eslint-plugin-sonarjs`](https://github.com/SonarSource/SonarJS)                                                      | 137         | 269   | 51%      |
