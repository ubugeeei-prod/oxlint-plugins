...
**26** ESLint plugins are being ported · **698 / 1159** rules implemented (**60%**).
...
| [`sonarjs`](npm/sonarjs)                                   | [`eslint-plugin-sonarjs`](https://github.com/SonarSource/SonarJS)                                                      | 160         | 269   | 59%      |
