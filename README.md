...
**26** ESLint plugins are being ported · **699 / 1159** rules implemented (**60%**).
...
| [`sonarjs`](npm/sonarjs)                                   | [`eslint-plugin-sonarjs`](https://github.com/SonarSource/SonarJS)                                                      | 161         | 269   | 60%      |
