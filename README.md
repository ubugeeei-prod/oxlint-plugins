...
**26** ESLint plugins are being ported · **728 / 1159** rules implemented (**63%**).
...
| [`sonarjs`](npm/sonarjs)                                   | [`eslint-plugin-sonarjs`](https://github.com/SonarSource/SonarJS)                                                      | 190         | 269   | 71%      |
