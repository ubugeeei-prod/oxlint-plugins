...
**26** ESLint plugins are being ported · **695 / 1159** rules implemented (**60%**).
...
| [`sonarjs`](npm/sonarjs)                                   | [`eslint-plugin-sonarjs`](https://github.com/SonarSource/SonarJS)                                                      | 157         | 269   | 58%      |
