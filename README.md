...
**26** ESLint plugins are being ported · **767 / 1159** rules implemented (**66%**).
...
| [`sonarjs`](npm/sonarjs)                                   | [`eslint-plugin-sonarjs`](https://github.com/SonarSource/SonarJS)                                                      | 229         | 269   | 85%      |
