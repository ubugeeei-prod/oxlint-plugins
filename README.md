...
**26** ESLint plugins are being ported · **680 / 1159** rules implemented (**59%**).
...
| [`sonarjs`](npm/sonarjs)                                   | [`eslint-plugin-sonarjs`](https://github.com/SonarSource/SonarJS)                                                      | 142         | 269   | 53%      |
