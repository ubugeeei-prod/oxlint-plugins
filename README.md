...
**26** ESLint plugins are being ported · **677 / 1159** rules implemented (**58%**).
...
| [`sonarjs`](npm/sonarjs)                                   | [`eslint-plugin-sonarjs`](https://github.com/SonarSource/SonarJS)                                                      | 139         | 269   | 52%      |
