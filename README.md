...
**26** ESLint plugins are being ported · **736 / 1159** rules implemented (**64%**).
...
| [`sonarjs`](npm/sonarjs)                                   | [`eslint-plugin-sonarjs`](https://github.com/SonarSource/SonarJS)                                                      | 198         | 269   | 74%      |
