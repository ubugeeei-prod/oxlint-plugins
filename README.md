...
**26** ESLint plugins are being ported · **643 / 1159** rules implemented (**55%**).
...
| [`sonarjs`](npm/sonarjs)                                   | [`eslint-plugin-sonarjs`](https://github.com/SonarSource/SonarJS)                                                      | 109         | 269   | 41%      |
