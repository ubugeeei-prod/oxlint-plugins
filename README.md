...
**26** ESLint plugins are being ported · **610 / 1159** rules implemented (**53%**).
...
| [`sonarjs`](npm/sonarjs)                                   | [`eslint-plugin-sonarjs`](https://github.com/SonarSource/SonarJS)                                                      | 84          | 269   | 31%      |
