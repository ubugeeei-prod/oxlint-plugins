...
**26** ESLint plugins are being ported · **755 / 1159** rules implemented (**65%**).
...
| [`sonarjs`](npm/sonarjs)                                   | [`eslint-plugin-sonarjs`](https://github.com/SonarSource/SonarJS)                                                      | 217         | 269   | 81%      |
