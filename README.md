...
**26** ESLint plugins are being ported · **617 / 1159** rules implemented (**53%**).
...
| [`sonarjs`](npm/sonarjs)                                   | [`eslint-plugin-sonarjs`](https://github.com/SonarSource/SonarJS)                                                      | 87          | 269   | 32%      |
