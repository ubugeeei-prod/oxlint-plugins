...
**26** ESLint plugins are being ported · **660 / 1159** rules implemented (**57%**).
...
| [`sonarjs`](npm/sonarjs)                                   | [`eslint-plugin-sonarjs`](https://github.com/SonarSource/SonarJS)                                                      | 125         | 269   | 46%      |
