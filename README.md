...
**26** ESLint plugins are being ported · **676 / 1159** rules implemented (**58%**).
...
| [`sonarjs`](npm/sonarjs)                                   | [`eslint-plugin-sonarjs`](https://github.com/SonarSource/SonarJS)                                                      | 138         | 269   | 51%      |
