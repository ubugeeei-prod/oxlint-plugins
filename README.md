...
**25** ESLint plugins are being ported · **786 / 981** rules implemented (**80%**).
...
| [`sonarjs`](npm/sonarjs)                                   | [`eslint-plugin-sonarjs`](https://github.com/SonarSource/SonarJS)                                                      | 234         | 276   | 85%      |
| [`storybook`](npm/storybook)                               | [`eslint-plugin-storybook`](https://github.com/storybookjs/storybook)                                                  | 16          | 16    | 100%     |
| [`stylistic`](npm/stylistic)                               | [`corsa-oxlint/stylistic`](https://github.com/ubugeeei-prod/corsa-bind)                                                | 66          | 98    | 67%      |
...
<details>
<summary><code>e18e</code> — 25/27 implemented</summary>
...
**Not implemented (2):** `prefer-flatmap-over-map-flat`, `prefer-get-or-insert`
...
<details>
<summary><code>sonarjs</code> — 234/276 implemented</summary>

**Implemented (234):** `anchor-precedence`, `argument-type`, `arguments-order`, `arguments-usage`, `array-callback-without-return`, `array-constructor`, `aws-apigateway-public-api`, `aws-ec2-rds-dms-public`, `aws-ec2-unencrypted-ebs-volume`, `aws-efs-unencrypted`, `aws-iam-all-privileges`, `aws-iam-all-resources-accessible`, `aws-iam-public-access`, `aws-opensearchservice-domain`, `aws-rds-unencrypted-databases`, `aws-restricted-ip-admin-access`, `aws-s3-bucket-granted-access`, `aws-s3-bucket-insecure-http`, `aws-s3-bucket-public-access`, `aws-s3-bucket-server-encryption`, `aws-s3-bucket-versioning`, `aws-sagemaker-unencrypted-notebook`, `aws-sns-unencrypted-topics`, `aws-sqs-unencrypted-queue`, `bitwise-operators`, `block-scoped-var`, `bool-param-default`, `call-argument-line`, `certificate-transparency`, `chai-determinate-assertion`, `class-name`, `class-prototype`, `code-eval`, `cognitive-complexity`, `comma-or-logical-or-case`, `concise-regex`, `confidential-information-logging`, `constructor-for-side-effects`, `content-length`, `content-security-policy`, `cookie-no-httponly`, `cookies`, `cors`, `csrf`, `cyclomatic-complexity`, `declarations-in-global-scope`, `deprecation`, `destructuring-assignment-syntax`, `different-types-comparison`, `disabled-auto-escaping`, `disabled-timeout`, `dns-prefetching`, `duplicates-in-character-class`, `elseif-without-else`, `empty-string-repetition`, `encryption`, `encryption-secure-mode`, `existing-groups`, `expression-complexity`, `file-name-differ-from-class`, `file-permissions`, `file-uploads`, `fixme-tag`, `for-in`, `for-loop-increment-sign`, `frame-ancestors`, `function-inside-loop`, `function-name`, `generator-without-yield`, `hashing`, `hidden-files`, `in-operator-type-error`, `inconsistent-function-call`, `index-of-compare-to-positive-number`, `insecure-cookie`, `insecure-jwt-token`, `inverted-assertion-arguments`, `jsx-no-leaked-render`, `label-position`, `link-with-target-blank`, `max-lines`, `max-lines-per-function`, `max-switch-cases`, `max-union-size`, `misplaced-loop-counter`, `nested-control-flow`, `new-operator-misuse`, `no-all-duplicated-branches`, `no-alphabetical-sort`, `no-angular-bypass-sanitization`, `no-array-delete`, `no-associative-arrays`, `no-async-constructor`, `no-built-in-override`, `no-case-label-in-switch`, `no-clear-text-protocols`, `no-code-after-done`, `no-collapsible-if`, `no-collection-size-mischeck`, `no-commented-code`, `no-control-regex`, `no-delete-var`, `no-duplicate-in-composite`, `no-duplicate-string`, `no-duplicated-branches`, `no-element-overwrite`, `no-empty-after-reluctant`, `no-empty-alternatives`, `no-empty-character-class`, `no-empty-collection`, `no-empty-group`, `no-empty-test-file`, `no-equals-in-for-termination`, `no-exclusive-tests`, `no-extra-arguments`, `no-fallthrough`, `no-for-in-iterable`, `no-function-declaration-in-block`, `no-global-this`, `no-globals-shadowing`, `no-hardcoded-ip`, `no-hardcoded-passwords`, `no-hardcoded-secrets`, `no-hook-setter-in-body`, `no-identical-conditions`, `no-identical-expressions`, `no-identical-functions`, `no-ignored-exceptions`, `no-ignored-return`, `no-in-misuse`, `no-incomplete-assertions`, `no-inconsistent-returns`, `no-incorrect-string-concat`, `no-intrusive-permissions`, `no-invalid-regexp`, `no-invariant-returns`, `no-inverted-boolean-check`, `no-ip-forward`, `no-labels`, `no-literal-call`, `no-mime-sniff`, `no-misleading-array-reverse`, `no-misleading-character-class`, `no-nested-assignment`, `no-nested-conditional`, `no-nested-functions`, `no-nested-incdec`, `no-nested-switch`, `no-nested-template-literals`, `no-os-command-from-path`, `no-parameter-reassignment`, `no-primitive-wrappers`, `no-redundant-assignments`, `no-redundant-boolean`, `no-redundant-jump`, `no-redundant-optional`, `no-redundant-parentheses`, `no-referrer-policy`, `no-regex-spaces`, `no-require-or-define`, `no-return-type-any`, `no-same-argument-assert`, `no-same-line-conditional`, `no-skipped-tests`, `no-small-switch`, `no-sonar-comments`, `no-tab`, `no-table-as-layout`, `no-undefined-argument`, `no-undefined-assignment`, `no-unenclosed-multiline-block`, `no-uniq-key`, `no-unsafe-unzip`, `no-unthrown-error`, `no-unused-collection`, `no-unused-function-argument`, `no-unused-vars`, `no-use-of-empty-return-value`, `no-useless-catch`, `no-useless-increment`, `no-useless-intersection`, `no-useless-react-setstate`, `no-variable-usage-before-declaration`, `no-vue-bypass-sanitization`, `no-weak-cipher`, `no-weak-keys`, `no-wildcard-import`, `non-existent-operator`, `non-number-in-arithmetic-expression`, `object-alt-content`, `operation-returning-nan`, `os-command`, `post-message`, `prefer-default-last`, `prefer-immediate-return`, `prefer-object-literal`, `prefer-promise-shorthand`, `prefer-regexp-exec`, `prefer-single-boolean-return`, `prefer-while`, `process-argv`, `production-debug`, `pseudo-random`, `public-static-readonly`, `publicly-writable-directories`, `reduce-initial-value`, `redundant-type-aliases`, `regular-expr`, `shorthand-property-grouping`, `single-char-in-character-classes`, `single-character-alternation`, `slow-regex`, `sockets`, `standard-input`, `strict-transport-security`, `strings-comparison`, `table-header`, `table-header-reference`, `todo-tag`, `too-many-break-or-continue-in-loop`, `unicode-aware-regex`, `unused-import`, `unverified-certificate`, `unverified-hostname`, `updated-const-var`, `updated-loop-counter`, `use-type-alias`, `useless-string-operation`, `values-not-convertible-to-numbers`, `void-use`, `weak-ssl`, `web-sql-database`, `xml-parser-xxe`, `xpath`

**Not implemented (42):** `arrow-function-convention`, `assertions-in-tests`, `async-test-assertions`, `aws-iam-privilege-escalation`, `comment-regex`, `conditional-indentation`, `disabled-resource-integrity`, `dompurify-unsafe-config`, `dynamically-constructed-templates`, `file-header`, `function-return-type`, `future-reserved-words`, `hardcoded-secret-signatures`, `hooks-before-test-cases`, `no-dead-store`, `no-duplicate-test-title`, `no-empty-test-title`, `no-floating-point-equality`, `no-forced-browser-interaction`, `no-gratuitous-expressions`, `no-implicit-dependencies`, `no-implicit-global`, `no-internal-api-use`, `no-mixed-content`, `no-reference-error`, `no-selector-parameter`, `no-session-cookies-on-static-assets`, `no-try-promise`, `null-dereference`, `prefer-read-only-props`, `prefer-type-guard`, `regex-complexity`, `review-blockchain-mnemonic`, `session-regeneration`, `sql-queries`, `stable-tests`, `stateful-regex`, `super-linear-regex`, `test-check-exception`, `unused-named-groups`, `variable-name`, `x-powered-by`
...
<details>
<summary><code>stylistic</code> — 66/98 implemented</summary>

**Implemented (66):** `array-bracket-newline`, `array-bracket-spacing`, `array-element-newline`, `arrow-parens`, `arrow-spacing`, `block-spacing`, `brace-style`, `comma-dangle`, `comma-spacing`, `comma-style`, `computed-property-spacing`, `dot-location`, `eol-last`, `function-call-argument-newline`, `function-call-spacing`, `function-paren-newline`, `generator-star-spacing`, `implicit-arrow-linebreak`, `indent-binary-ops`, `jsx-equals-spacing`, `jsx-quotes`, `key-spacing`, `keyword-spacing`, `line-comment-position`, `linebreak-style`, `lines-around-comment`, `lines-between-class-members`, `max-len`, `max-statements-per-line`, `multiline-comment-style`, `multiline-ternary`, `new-parens`, `newline-per-chained-call`, `no-confusing-arrow`, `no-extra-semi`, `no-floating-decimal`, `no-mixed-operators`, `no-mixed-spaces-and-tabs`, `no-multi-spaces`, `no-multiple-empty-lines`, `no-tabs`, `no-trailing-spaces`, `no-whitespace-before-property`, `object-curly-newline`, `object-curly-spacing`, `one-var-declaration-per-line`, `operator-linebreak`, `padded-blocks`, `quote-props`, `quotes`, `rest-spread-spacing`, `semi-spacing`, `semi-style`, `space-before-blocks`, `space-before-function-paren`, `space-in-parens`, `space-infix-ops`, `space-unary-ops`, `spaced-comment`, `switch-colon-spacing`, `template-curly-spacing`, `template-tag-spacing`, `type-annotation-spacing`, `unicode-bom`, `wrap-regex`, `yield-star-spacing`

**Not implemented (32):** `curly-newline`, `exp-jsx-props-style`, `exp-list-style`, `indent`, `jsx-child-element-spacing`, `jsx-closing-bracket-location`, `jsx-closing-tag-location`, `jsx-curly-brace-presence`, `jsx-curly-newline`, `jsx-curly-spacing`, `jsx-first-prop-new-line`, `jsx-function-call-newline`, `jsx-indent`, `jsx-indent-props`, `jsx-max-props-per-line`, `jsx-newline`, `jsx-one-expression-per-line`, `jsx-pascal-case`, `jsx-props-no-multi-spaces`, `jsx-self-closing-comp`, `jsx-sort-props`, `jsx-tag-spacing`, `jsx-wrap-multilines`, `member-delimiter-style`, `no-extra-parens`, `nonblock-statement-body-position`, `object-property-newline`, `padding-line-between-statements`, `semi`, `type-generic-spacing`, `type-named-tuple-spacing`, `wrap-iife`
