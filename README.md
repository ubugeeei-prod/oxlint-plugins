...
**26** ESLint plugins are being ported · **654 / 1159** rules implemented (**56%**).
...
| [`sonarjs`](npm/sonarjs)                                   | [`eslint-plugin-sonarjs`](https://github.com/SonarSource/SonarJS)                                                      | 119         | 269   | 44%      |
