...
**26** ESLint plugins are being ported · **689 / 1159** rules implemented (**59%**).
...
| [`sonarjs`](npm/sonarjs)                                   | [`eslint-plugin-sonarjs`](https://github.com/SonarSource/SonarJS)                                                      | 151         | 269   | 56%      |
