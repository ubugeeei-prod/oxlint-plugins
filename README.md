...
**26** ESLint plugins are being ported · **709 / 1159** rules implemented (**61%**).
...
| [`sonarjs`](npm/sonarjs)                                   | [`eslint-plugin-sonarjs`](https://github.com/SonarSource/SonarJS)                                                      | 171         | 269   | 64%      |
