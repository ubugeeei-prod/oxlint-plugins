...
**26** ESLint plugins are being ported · **674 / 1159** rules implemented (**58%**).
...
| [`sonarjs`](npm/sonarjs)                                   | [`eslint-plugin-sonarjs`](https://github.com/SonarSource/SonarJS)                                                      | 136         | 269   | 51%      |
