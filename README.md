...
**26** ESLint plugins are being ported · **682 / 1159** rules implemented (**59%**).
...
| [`sonarjs`](npm/sonarjs)                                   | [`eslint-plugin-sonarjs`](https://github.com/SonarSource/SonarJS)                                                      | 144         | 269   | 54%      |
