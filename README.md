...
**26** ESLint plugins are being ported · **554 / 1159** rules implemented (**48%**).
...
| [`sonarjs`](npm/sonarjs)                                   | [`eslint-plugin-sonarjs`](https://github.com/SonarSource/SonarJS)                                                      | 65          | 269   | 24%      |
