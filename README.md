...
**26** ESLint plugins are being ported · **711 / 1159** rules implemented (**61%**).
...
| [`sonarjs`](npm/sonarjs)                                   | [`eslint-plugin-sonarjs`](https://github.com/SonarSource/SonarJS)                                                      | 173         | 269   | 64%      |
