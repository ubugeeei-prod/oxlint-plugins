...
**26** ESLint plugins are being ported · **724 / 1159** rules implemented (**62%**).
...
| [`sonarjs`](npm/sonarjs)                                   | [`eslint-plugin-sonarjs`](https://github.com/SonarSource/SonarJS)                                                      | 186         | 269   | 69%      |
