...
**26** ESLint plugins are being ported · **704 / 1159** rules implemented (**61%**).
...
| [`sonarjs`](npm/sonarjs)                                   | [`eslint-plugin-sonarjs`](https://github.com/SonarSource/SonarJS)                                                      | 166         | 269   | 62%      |
