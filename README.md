...
**26** ESLint plugins are being ported · **719 / 1159** rules implemented (**62%**).
...
| [`sonarjs`](npm/sonarjs)                                   | [`eslint-plugin-sonarjs`](https://github.com/SonarSource/SonarJS)                                                      | 181         | 269   | 67%      |
...
<details>
<summary><code>sonarjs</code> — 181/269 implemented</summary>

**Implemented (181):** `anchor-precedence`, `arguments-order`, `arguments-usage`, `array-callback-without-return`, `array-constructor`, `aws-apigateway-public-api`, `aws-ec2-rds-dms-public`, `aws-iam-all-privileges`, `aws-iam-public-access`, `aws-rds-unencrypted-databases`, `aws-s3-bucket-granted-access`, `aws-s3-bucket-public-access`, `aws-s3-bucket-versioning`, `aws-sqs-unencrypted-queue`, `bitwise-operators`, `block-scoped-var`, `bool-param-default`, `call-argument-line`, `certificate-transparency`, `class-name`, `class-prototype`, `code-eval`, `cognitive-complexity`, `comma-or-logical-or-case`, `concise-regex`, `confidential-information-logging`, `constructor-for-side-effects`, `content-security-policy`, `cookie-no-httponly`, `cors`, `csrf`, `cyclomatic-complexity`, `declarations-in-global-scope`, `deprecation`, `destructuring-assignment-syntax`, `different-types-comparison`, `disabled-auto-escaping`, `disabled-timeout`, `dns-prefetching`, `duplicates-in-character-class`, `elseif-without-else`, `empty-string-repetition`, `encryption-secure-mode`, `expression-complexity`, `file-name-differ-from-class`, `file-permissions`, `file-uploads`, `fixme-tag`, `for-in`, `for-loop-increment-sign`, `function-inside-loop`, `function-name`, `generator-without-yield`, `hashing`, `hidden-files`, `in-operator-type-error`, `inconsistent-function-call`, `index-of-compare-to-positive-number`, `inverted-assertion-arguments`, `label-position`, `link-with-target-blank`, `max-lines`, `max-lines-per-function`, `max-switch-cases`, `max-union-size`, `misplaced-loop-counter`, `nested-control-flow`, `new-operator-misuse`, `no-all-duplicated-branches`, `no-alphabetical-sort`, `no-array-delete`, `no-associative-arrays`, `no-built-in-override`, `no-case-label-in-switch`, `no-clear-text-protocols`, `no-code-after-done`, `no-collapsible-if`, `no-collection-size-mischeck`, `no-commented-code`, `no-control-regex`, `no-delete-var`, `no-duplicate-in-composite`, `no-duplicate-string`, `no-duplicated-branches`, `no-element-overwrite`, `no-empty-after-reluctant`, `no-empty-alternatives`, `no-empty-character-class`, `no-empty-collection`, `no-empty-group`, `no-empty-test-file`, `no-equals-in-for-termination`, `no-exclusive-tests`, `no-extra-arguments`, `no-fallthrough`, `no-for-in-iterable`, `no-function-declaration-in-block`, `no-global-this`, `no-hardcoded-ip`, `no-hardcoded-passwords`, `no-hardcoded-secrets`, `no-identical-conditions`, `no-identical-expressions`, `no-identical-functions`, `no-ignored-exceptions`, `no-ignored-return`, `no-in-misuse`, `no-incomplete-assertions`, `no-inconsistent-returns`, `no-intrusive-permissions`, `no-invalid-regexp`, `no-invariant-returns`, `no-inverted-boolean-check`, `no-labels`, `no-literal-call`, `no-misleading-array-reverse`, `no-misleading-character-class`, `no-nested-assignment`, `no-nested-conditional`, `no-nested-functions`, `no-nested-incdec`, `no-nested-switch`, `no-nested-template-literals`, `no-parameter-reassignment`, `no-primitive-wrappers`, `no-redundant-assignments`, `no-redundant-boolean`, `no-redundant-jump`, `no-redundant-optional`, `no-redundant-parentheses`, `no-regex-spaces`, `no-require-or-define`, `no-same-argument-assert`, `no-same-line-conditional`, `no-skipped-tests`, `no-small-switch`, `no-sonar-comments`, `no-tab`, `no-undefined-argument`, `no-undefined-assignment`, `no-unenclosed-multiline-block`, `no-unsafe-unzip`, `no-unthrown-error`, `no-unused-collection`, `no-unused-function-argument`, `no-use-of-empty-return-value`, `no-useless-catch`, `no-useless-increment`, `no-useless-intersection`, `no-variable-usage-before-declaration`, `no-weak-cipher`, `no-wildcard-import`, `non-existent-operator`, `object-alt-content`, `operation-returning-nan`, `post-message`, `prefer-default-last`, `prefer-immediate-return`, `prefer-object-literal`, `prefer-promise-shorthand`, `prefer-regexp-exec`, `prefer-single-boolean-return`, `prefer-while`, `process-argv`, `production-debug`, `pseudo-random`, `public-static-readonly`, `reduce-initial-value`, `shorthand-property-grouping`, `single-char-in-character-classes`, `single-character-alternation`, `slow-regex`, `standard-input`, `todo-tag`, `too-many-break-or-continue-in-loop`, `unicode-aware-regex`, `updated-const-var`, `updated-loop-counter`, `use-type-alias`, `void-use`, `web-sql-database`

**Not implemented (88):** `argument-type`, `arrow-function-convention`, `assertions-in-tests`, `aws-ec2-unencrypted-ebs-volume`, `aws-efs-unencrypted`, `aws-iam-all-resources-accessible`, `aws-iam-privilege-escalation`, `aws-opensearchservice-domain`, `aws-restricted-ip-admin-access`, `aws-s3-bucket-insecure-http`, `aws-s3-bucket-server-encryption`, `aws-sagemaker-unencrypted-notebook`, `aws-sns-unencrypted-topics`, `chai-determinate-assertion`, `comment-regex`, `conditional-indentation`, `content-length`, `cookies`, `disabled-resource-integrity`, `dompurify-unsafe-config`, `dynamically-constructed-templates`, `encryption`, `existing-groups`, `file-header`, `frame-ancestors`, `function-return-type`, `future-reserved-words`, `hardcoded-secret-signatures`, `insecure-cookie`, `insecure-jwt-token`, `jsx-no-leaked-render`, `no-angular-bypass-sanitization`, `no-async-constructor`, `no-dead-store`, `no-globals-shadowing`, `no-gratuitous-expressions`, `no-hook-setter-in-body`, `no-implicit-dependencies`, `no-implicit-global`, `no-incorrect-string-concat`, `no-internal-api-use`, `no-ip-forward`, `no-mime-sniff`, `no-mixed-content`, `no-os-command-from-path`, `no-reference-error`, `no-referrer-policy`, `no-return-type-any`, `no-selector-parameter`, `no-session-cookies-on-static-assets`, `no-table-as-layout`, `no-try-promise`, `no-uniq-key`, `no-unused-vars`, `no-useless-react-setstate`, `no-vue-bypass-sanitization`, `no-weak-keys`, `non-number-in-arithmetic-expression`, `null-dereference`, `os-command`, `prefer-read-only-props`, `prefer-type-guard`, `publicly-writable-directories`, `redundant-type-aliases`, `regex-complexity`, `regular-expr`, `review-blockchain-mnemonic`, `session-regeneration`, `sockets`, `sql-queries`, `stable-tests`, `stateful-regex`, `strict-transport-security`, `strings-comparison`, `table-header`, `table-header-reference`, `test-check-exception`, `unused-import`, `unused-named-groups`, `unverified-certificate`, `unverified-hostname`, `useless-string-operation`, `values-not-convertible-to-numbers`, `variable-name`, `weak-ssl`, `x-powered-by`, `xml-parser-xxe`, `xpath`
