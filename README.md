...
**26** ESLint plugins are being ported · **629 / 1159** rules implemented (**54%**).
...
| [`sonarjs`](npm/sonarjs)                                   | [`eslint-plugin-sonarjs`](https://github.com/SonarSource/SonarJS)                                                      | 95          | 269   | 35%      |
