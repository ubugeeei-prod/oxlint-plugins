...
**26** ESLint plugins are being ported · **633 / 1159** rules implemented (**55%**).
...
| [`sonarjs`](npm/sonarjs)                                   | [`eslint-plugin-sonarjs`](https://github.com/SonarSource/SonarJS)                                                      | 99          | 269   | 37%      |
