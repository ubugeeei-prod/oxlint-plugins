...
**26** ESLint plugins are being ported · **638 / 1159** rules implemented (**55%**).
...
| [`sonarjs`](npm/sonarjs)                                   | [`eslint-plugin-sonarjs`](https://github.com/SonarSource/SonarJS)                                                      | 104         | 269   | 39%      |
