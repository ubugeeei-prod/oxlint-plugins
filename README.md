...
**25** ESLint plugins are being ported · **793 / 981** rules implemented (**81%**).
...
| [`stylistic`](npm/stylistic)                               | [`corsa-oxlint/stylistic`](https://github.com/ubugeeei-prod/corsa-bind)                                                | 72          | 98    | 73%      |
